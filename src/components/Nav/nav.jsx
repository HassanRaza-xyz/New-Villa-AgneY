    ...
    <div className="header">
      ...
      <nav className="navbar navbar-expand-lg">
        <div className="container">
          <Link className="navbar-brand logo text-white me-4" to="/">VILLA</Link>
          ...
          <div className="collapse navbar-collapse nav-links" id="navbarNav">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <Link className="nav-link" to="/about">Property</Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link" to="/PropertyDetails">Property Details</Link>
              </li>
              <li className="nav-item">
